...
var
  len: integer;
begin
 //failed : first read = part offset?
//if first=true then begin FStream.Seek (2048*512,0);first:=false;end;
//FStream.Position :=FStream.Position +(2048*512);
//if FStream.Position=0 then FStream.Position :=2048*512;
OutputDebugString(pchar(inttostr(FStream.Position)));
...
begin
//test : always apply offset?
//seekOrigin:=seekOrigin+(2048*512);
